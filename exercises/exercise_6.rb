...
@store3.employees.create(first_name: "Donald", last_name: "Johnson", hourly_rate: 40)
...
@store6.employees.create(first_name: "Jimmy", last_name: "Maher", hourly_rate: 70)
@store6.employees.create(first_name: "Trevor", last_name: "Oliver", hourly_rate: 60)